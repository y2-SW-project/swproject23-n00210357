    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class ="flex">
                ...
                <a href="{{ route('angler.destinations.edit', $destination) }}" class="btn-link ml-auto">Edit Destination</a>

                <form action="{{ route('angler.destinations.destroy', $destination) }}" method="post">
                    @method('delete')
                    @csrf
