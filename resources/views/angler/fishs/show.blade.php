    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class ="flex">
                ...
                <a href="{{ route('angler.trains.edit', $fish) }}" class="btn-link ml-auto">Edit Fish</a>

                <form action="{{ route('angler.trains.destroy', $fish) }}" method="post">
                    @method('delete')
                    @csrf
                ...
                <table>
                    <tbody>
                        ...
                        <div>
                            @foreach ($fish->catcher as $catcher)
                            <tr>
                                <td class="font-bold">Catcher</td>
                                <td> {{$catcher->first_name}} </td>
                                <td> {{$catcher->last_name}} </td>
                            </tr>
                            @endforeach
                        </div>
                            </tbody>
