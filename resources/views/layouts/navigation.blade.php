<nav class="border-top border-bottom border-3">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="row text-center align-items-center">
                ...
                <div class="col">
                    <x-nav-link :href="route('home.index')" :active="request()->routeIs('home.index')" class="text-decoration-none te">
                        <div class="d-flex colours">
                        <div class="d-flex px-1">
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-shield twist" viewBox="0 0 16 16">
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" class="bi bi-caret-left" viewBox="4 0 16 16">
            ...
            <div class="col dropdown align-self-center size2 colours">
