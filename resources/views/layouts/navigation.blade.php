<nav class="border-top border-bottom border-3 shade">
                    ...
                    <x-nav-link :href="route('home.index')" :active="request()->routeIs('home.index')" class="text-decoration-none te">
                        <div class="d-none d-xl-block">
                            ...
                            <div class="d-flex px-1">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-shield twist" viewBox="0 0 16 16">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-caret-left" viewBox="4 0 16 16">
                                    <path d="M10 12.796V3.204L4.519 8 10 12.796zm-.659.753-5.48-4.796a1 1 0 0 1 0-1.506l5.48-4.796A1 1 0 0 1 11 3.204v9.592a1 1 0 0 1-1.659.753z"/>
                                </svg>
                            </div>

                            <h2 class="size2">{{ __('Fishes') }}</h2>
                        </div>
                    </div>
                ...
                <div class="col">
                    <x-nav-link :href="route('home.fishery.index')" :active="request()->routeIs('home.fishery.index')" class="text-decoration-none">
                        ...
                        <div class="d-flex colours align-items-center">
                            ...
                            <h2 class="size2">{{ __('Fisheries') }}</h2>
                            </div>
                        </div>
